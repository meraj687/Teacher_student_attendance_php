...
<body>
 ...
 <option value="attendanceport.php">Semester 1 </option> 
 <option value="attendanceport1.php">Semester 2 </option> 
 <option value="attendanceport2.php">Semester 3 </option> 
 <option value="attendanceport3.php">Semester 4 </option> 
 <option value="attendanceport4.php">Semester 5 </option> 
 <option value="attendanceport5.php">Semester 6 </option> 
</select> 
  </center>
